...
function module:start()
    ...
    Instance.new("UIStroke", ServerHop).Color = Color3.fromRGB(53, 53, 53).ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    Instance.new("UICorner", ServerHop).CornerRadius = UDim.new(0, 4)
    ...
    Rejoin.Text = "Rejoin"
    Instance.new("UIStroke", Rejoin).Color = Color3.fromRGB(53, 53, 53).ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    Instance.new("UICorner", Rejoin).CornerRadius = UDim.new(0, 4)
    ...
    Instance.new("UIStroke", CopyTemplate).Color = Color3.fromRGB(53, 53, 53).ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    Instance.new("UICorner", CopyTemplate).CornerRadius = UDim.new(0, 4)
    ...
    Instance.new("UICorner", UserIcon)
    Instance.new("UIStroke", UserIcon).Color = Color3.fromRGB(49, 49, 49)
    ...
    Instance.new("Frame", UserContainer).Name = "Separator"
    ...
    function start:AddPlayer(player, inventoryCost, isElite, eliminations, survivals, level)
        ...
        Instance.new("UIStroke", playerFrame).Transparency = 0.5.Color = Color3.fromRGB(85, 85, 85)
        ...
        Instance.new("UICorner", TargetIcon).CornerRadius = UDim.new(0, 12)
        Instance.new("UIStroke", TargetIcon).Color = Color3.fromRGB(49, 49, 49)
